...
class TestSessions:
    ...
    @parametrize
    def test_method_process_messages(self, client: Papr) -> None:
        session = client.messages.sessions.process_messages(
            "sessionId",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_process_messages(self, client: Papr) -> None:
        response = client.messages.sessions.with_raw_response.process_messages(
            "sessionId",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_process_messages(self, client: Papr) -> None:
        with client.messages.sessions.with_streaming_response.process_messages(
            "sessionId",
        ) as response:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_process_messages(self, client: Papr) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `session_id` but received ''"):
            client.messages.sessions.with_raw_response.process_messages(
                "",
            )
...
class TestAsyncSessions:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_process_messages(self, async_client: AsyncPapr) -> None:
        session = await async_client.messages.sessions.process_messages(
            "sessionId",
        )
        assert_matches_type(object, session, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_process_messages(self, async_client: AsyncPapr) -> None:
        response = await async_client.messages.sessions.with_raw_response.process_messages(
            "sessionId",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_process_messages(self, async_client: AsyncPapr) -> None:
        async with async_client.messages.sessions.with_streaming_response.process_messages(
            "sessionId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_process_messages(self, async_client: AsyncPapr) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `session_id` but received ''"):
            await async_client.messages.sessions.with_raw_response.process_messages(
                "",
            )
