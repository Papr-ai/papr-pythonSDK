...
from ..types.shared_params.node_constraint_input import NodeConstraintInput
from ..types.shared_params.edge_constraint_input import EdgeConstraintInput
...
def _build_relationship_type(edge_name: str, edge_desc: EdgeDescriptor) -> Dict[str, Any]:
    ...
    if edge_desc.properties:
        rel_type["properties"] = {
            prop_name: prop_desc.to_property_definition()
            for prop_name, prop_desc in edge_desc.properties.items()
        }
