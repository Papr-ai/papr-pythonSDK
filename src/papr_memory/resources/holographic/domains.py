...
from ...types.holographic import domain_create_params
from ...types.holographic.domain_list_response import DomainListResponse
from ...types.holographic.domain_create_response import DomainCreateResponse
...
class DomainsResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        fields: Iterable[domain_create_params.Field],
        name: str,
        ...
        """Define a custom frequency schema for your specific domain.
        ...
        Args:
          fields: Frequency field definitions (1-14 fields, one per frequency band)

          name: Schema name in format 'company:domain:version' (e.g.
    ...
    def list(
        ...
        *,
        ...
        """Returns all available frequency schemas organized by domain.
