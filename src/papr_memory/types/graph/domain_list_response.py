...
__all__ = [
    ...
    "DomainSignal",
    "DomainCatalog",
    "DomainCatalogEntityCluster",
    "DomainCatalogRelationshipPattern",
    "DomainCatalogBuffer",
    "DomainCatalogConfig",
    "DomainRoutingConfig",
]
...
class DomainCatalogEntityCluster(BaseModel):
...
class DomainCatalogRelationshipPattern(BaseModel):
...
class DomainCatalog(BaseModel):
    ...
    entity_clusters: Optional[List[DomainCatalogEntityCluster]] = None
    ...
    relationship_patterns: Optional[List[DomainCatalogRelationshipPattern]] = None
...
class DomainCatalogBuffer(BaseModel):
...
class Domain(BaseModel):
    ...
    catalog_buffer: Optional[List[DomainCatalogBuffer]] = None
    ...
    routing_config: Optional[DomainRoutingConfig] = None
    """Domain-scoped CAESAR-VIII routing overrides (stored on graph_domains)."""
