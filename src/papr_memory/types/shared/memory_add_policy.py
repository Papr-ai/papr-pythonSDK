...
class MemoryAddPolicy(BaseModel):
    ...
    **Validation Rules:**
    ...
    consent: Optional[Literal["explicit", "implicit", "terms", "none"]] = None
    """How the data owner allowed this memory to be stored/used.

    Aligned with Open Memory Object (OMO) standard.
    """

    graph: Optional[GraphPolicyBlock] = None

    risk: Optional[Literal["none", "sensitive", "flagged"]] = None
    """Post-ingest safety assessment of memory content.

    Aligned with Open Memory Object (OMO) standard.
    """

    transform_embedding: Optional[TransformEmbeddingPolicy] = None
