...
class NodeTypesConstraintSearchProperty(TypedDict, total=False):
...
class NodeTypesConstraintSearch(TypedDict, total=False):
    ...
    **To select a specific node by ID**:
    ...
    properties: Optional[Iterable[NodeTypesConstraintSearchProperty]]
...
class NodeTypesConstraintSetPropertyValue(TypedDict, total=False):
...
NodeTypesConstraintSet: TypeAlias = Union[
    str, float, bool, Iterable[object], Dict[str, object], NodeTypesConstraintSetPropertyValue
]


class NodeTypesConstraint(TypedDict, total=False):
    ...
    **The `when` field** supports logical operators:
    ...
    search: Optional[NodeTypesConstraintSearch]
    """Configuration for finding/selecting existing nodes.
    ...
    **To select a specific node by ID**:
    ...
    set: Optional[Dict[str, NodeTypesConstraintSet]]
...
class NodeTypes(TypedDict, total=False):
    ...
    constraint: Optional[NodeTypesConstraint]
    """Policy for how nodes of a specific type should be handled.
...
class RelationshipTypesConstraintSearchProperty(TypedDict, total=False):
    """Property matching configuration.
...
class RelationshipTypesConstraintSearch(TypedDict, total=False):
    """Configuration for finding/selecting existing nodes.
    ...
    **To select a specific node by ID**:
    ...
    properties: Optional[Iterable[RelationshipTypesConstraintSearchProperty]]
    """Properties to match on, in priority order (first match wins).
...
class RelationshipTypesConstraintSetPropertyValue(TypedDict, total=False):
    """Configuration for a property value in NodeConstraint.set.
...
RelationshipTypesConstraintSet: TypeAlias = Union[
    str, float, bool, Iterable[object], Dict[str, object], RelationshipTypesConstraintSetPropertyValue
]


class RelationshipTypesConstraint(TypedDict, total=False):
    ...
    **The `when` field** supports logical operators (same as NodeConstraint):
    ...
    search: Optional[RelationshipTypesConstraintSearch]
    """Configuration for finding/selecting existing nodes.
    ...
    **To select a specific node by ID**:
    ...
    set: Optional[Dict[str, RelationshipTypesConstraintSet]]
...
class RelationshipTypes(TypedDict, total=False):
    ...
    constraint: Optional[RelationshipTypesConstraint]
    """Policy for how edges/relationships of a specific type should be handled.
